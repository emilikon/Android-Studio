...
class AlpacaParser {
    ...
    fun parse(inputStream: InputStream): List<AlpacaVotes> {
        inputStream.use {
    ...
    @Throws(XmlPullParserException::class, IOException::class)
    private fun readFeed(parser: XmlPullParser): List<AlpacaVotes> {
        val partyList = mutableListOf<AlpacaVotes>()
    ...
    @Throws(XmlPullParserException::class, IOException::class)
    private fun readEntry(parser: XmlPullParser): AlpacaVotes {
...
class AlpacaVotes(val id: String?, val votes: String?)

class BaseVotes(val votes: List<AlpacaVotes>){}